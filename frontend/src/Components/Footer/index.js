      ...
      <footer className="bg-light">
        <div className="container py-4">
          <div className="row g-4 mb-4">
            {[
              ...
              },
              {
                ...
                text: "Free delivery for orders over ₹199"
              },
              {
              ...
              <div className="col-md-3 col-6" key={index}>
                <div className="d-flex align-items-center">
                  <span className="me-2" style={{ color: "var(--raftaar-green)" }}>{item.icon}</span>
                  <span>{item.text}</span>
                </div>
              </div>
            ))}
          ...
          <div className="row g-4">
            {footerLinks.map((section, index) => (
              <div className="col-md-2 col-6" key={index}>
                <h5 className="h6 mb-3" style={{ color: "var(--raftaar-green)" }}>{section.title}</h5>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-center pt-4 mt-4 border-top">
            <p className="mb-3 mb-md-0" style={{ color: "var(--raftaar-text)" }}>
              &copy; {new Date().getFullYear()} RAFTAAR. All rights reserved
            </p>
            <div className="social-icons">
              {[
                ...
                <Link 
                  ...
                  style={{ color: "var(--raftaar-muted)", fontSize: "18px" }}
